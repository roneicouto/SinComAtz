...
uses
  ...
  Vcl.Controls, RzEdit, RzBtnEdt, Vcl.Graphics, Vcl.Buttons ;
...
//    property TabOnEnter default true;
  ...
  published
    ...
    property RequiredDisplay: String read FRequiredDisplay write FRequiredDisplay;
    property CharCase      ;
//    property TabOnEnter default false;
    property ShowHint      ;
    property Color         ;
  end;
...
procedure TxEdit.btnOlhoClick(Sender: TObject);
begin
...
procedure TxButtonEdit.SetAllowDeleteKey(const Value: Boolean);
begin
...
procedure TxEdit.SetMostraValor(const Value: Boolean);
begin
  FMostraValor     := Value;
